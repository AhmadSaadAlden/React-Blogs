...
const DataBlogPostsCard = [
    {
        img : `${process.env.PUBLIC_URL}/images/image1.png`, 
        alt : "Image1", 
    ...
    },
    {
        ...
        icon : <FiArrowUpRight />,
        descrption : "Starting a community doesn’t need to be complicated, but how do you get started?"
    },
]

export default DataBlogPostsCard